                ...
                <div class="item" style="background: url('{{ url('/core/public/storage/images/' . $slider->photo) }}')">
                    ...
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 d-flex align-self-center">
                            <div class="left-content color-white" style="text-align: {{ $slider->text_position ?? 'left' }}">
                                <div class="content">
                                    <div class="layer-1">
                                        <p class="subtitle" style="color: {{ $slider->title_color ?? '#ffffff' }}">
                                            {{ $slider->title }}
                                        </p>
                                    </div>
                                    <div class="layer-2">
                                        <h1 class="title" style="color: {{ $slider->text_color ?? '#ffffff' }}">
                                            {{ $slider->details }}
                                        </h1>
                                    </div>
                                    @if($slider->link != '#')
