								...
								<form class="admin-form" action="{{ route('back.shipping.store') }}" method="POST"
                                    ...
                                    <div class="form-group">
                                        <label class="text-left d-block">
                                            <input type="checkbox" name="is_condition" value="1" class="my-2">
                                            {{ __('Apply this shipping only after subtotal reaches a minimum amount') }}
                                        </label>
                                    </div>

                                    <div class="form-group">
                                        <label for="minimum_price">{{ __('Minimum Subtotal') }}</label>
                                        <div class="input-group mb-3">
                                            <div class="input-group-prepend">
                                            ...
                                            <input type="text" id="minimum_price"
                                                ...
                                                placeholder="{{ __('Enter Minimum Subtotal') }}"
                                                value="{{ old('minimum_price', 500) }}" >
                                        </div>
                                        <small class="text-muted">{{ __('Example: 500 means shipping will apply when cart subtotal is 500 or more.') }}</small>
                                    </div>
