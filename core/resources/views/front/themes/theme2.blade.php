                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="item-inner">
                                            <div class="from-bottom" style="text-align: {{ $slider->text_position ?? 'left' }}">
                                                @if ($slider->logo)
                                                    <img class="d-inline-block brand-logo"
                                                        src="{{ url('/core/public/storage/images/' . $slider->logo) }}" alt="logo">
                                                @endif

                                                <div class="title" style="color: {{ $slider->title_color ?? '#ffffff' }}">{{ $slider->title }}</div>
                                                <div class="subtitle" style="color: {{ $slider->text_color ?? '#ffffff' }}">{{ $slider->details }}</div>
                                            </div>
                                            @if($slider->link != '#')
                        ...
                        <a href="{{ $banner_first['firsturl1'] }}" class="genius-banner">
                            ...
                            <div class="inner-content">
                                @if (isset($banner_first['subtitle1']))
                                    <p style="{{ isset($banner_first['subtitle_color_1']) ? 'color:'.$banner_first['subtitle_color_1'] : '' }}">{{ $banner_first['subtitle1'] }}</p>
                                @endif
                                @if (isset($banner_first['title1']))
                                    <h4 style="{{ isset($banner_first['title_color_1']) ? 'color:'.$banner_first['title_color_1'] : '' }}">{{ $banner_first['title1'] }}</h4>
                                @endif
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ $banner_first['firsturl2'] }}" class="genius-banner">
                            ...
                            <div class="inner-content">
                                @if (isset($banner_first['subtitle2']))
                                    <p style="{{ isset($banner_first['subtitle_color_2']) ? 'color:'.$banner_first['subtitle_color_2'] : '' }}">{{ $banner_first['subtitle2'] }}</p>
                                @endif
                                @if (isset($banner_first['title2']))
                                    <h4 style="{{ isset($banner_first['title_color_2']) ? 'color:'.$banner_first['title_color_2'] : '' }}">{{ $banner_first['title2'] }}</h4>
                                @endif
                            </div>
                        </a>
                    </div>
                        ...
                        <a href="{{ $banner_first['firsturl3'] }}" class="genius-banner">
                            ...
                            <div class="inner-content">
                                @if (isset($banner_first['subtitle3']))
                                    <p style="{{ isset($banner_first['subtitle_color_3']) ? 'color:'.$banner_first['subtitle_color_3'] : '' }}"> {{ $banner_first['subtitle3'] }}</p>
                                @endif
                                @if (isset($banner_first['title3']))
                                    <h4 style="{{ isset($banner_first['title_color_3']) ? 'color:'.$banner_first['title_color_3'] : '' }}">{{ $banner_first['title3'] }}</h4>
                                @endif
                            </div>
                        </a>
                    </div>
                    ...
                    <a href="{{ $banner_secend['url1'] }}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            @if (isset($banner_secend['subtitle1']))
                                <p style="{{ isset($banner_secend['subtitle_color_1']) ? 'color:'.$banner_secend['subtitle_color_1'] : '' }}">{{ $banner_secend['subtitle1'] }}</p>
                            @endif

                            @if (isset($banner_secend['title1']))
                                <h4 style="{{ isset($banner_secend['title_color_1']) ? 'color:'.$banner_secend['title_color_1'] : '' }}">{{ $banner_secend['title1'] }}</h4>
                            @endif
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ $banner_secend['url2'] }}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            @if (isset($banner_secend['subtitle2']))
                                <p style="{{ isset($banner_secend['subtitle_color_2']) ? 'color:'.$banner_secend['subtitle_color_2'] : '' }}">{{ $banner_secend['subtitle2'] }}</p>
                            @endif

                            @if (isset($banner_secend['title2']))
                                <h4 style="{{ isset($banner_secend['title_color_2']) ? 'color:'.$banner_secend['title_color_2'] : '' }}"> {{ $banner_secend['title2'] }}</h4>
                            @endif
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ $banner_secend['url3'] }}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            @if (isset($banner_secend['subtitle3']))
                                <p style="{{ isset($banner_secend['subtitle_color_3']) ? 'color:'.$banner_secend['subtitle_color_3'] : '' }}"> {{ $banner_secend['subtitle3'] }}</p>
                            @endif

                            @if (isset($banner_secend['title3']))
                                <h4 style="{{ isset($banner_secend['title_color_3']) ? 'color:'.$banner_secend['title_color_3'] : '' }}">{{ $banner_secend['title3'] }}</h4>
                            @endif
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ $banner_third['url1'] }}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            @if (isset($banner_third['subtitle1']))
                                <p style="{{ isset($banner_third['subtitle_color_1']) ? 'color:'.$banner_third['subtitle_color_1'] : '' }}">{{ $banner_third['subtitle1'] }}</p>
                            @endif
                            @if (isset($banner_third['title1']))
                                <h4 style="{{ isset($banner_third['title_color_1']) ? 'color:'.$banner_third['title_color_1'] : '' }}">{{ $banner_third['title1'] }}</h4>
                            @endif
                        </div>
                    </a>
                </div>
                    ...
                    <a href="{{ $banner_third['url2'] }}" class="genius-banner">
                        ...
                        <div class="inner-content">
                            @if (isset($banner_third['subtitle2']))
                                <p style="{{ isset($banner_third['subtitle_color_2']) ? 'color:'.$banner_third['subtitle_color_2'] : '' }}"> {{ $banner_third['subtitle2'] }}</p>
                            @endif
                            @if (isset($banner_third['title2']))
                                <h4 style="{{ isset($banner_third['title_color_2']) ? 'color:'.$banner_third['title_color_2'] : '' }}">{{ $banner_third['title2'] }}</h4>
                            @endif
                        </div>
                    </a>
                </div>
