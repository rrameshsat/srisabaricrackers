                        ...
                        <div class="tab-pane fade show " id="v-pills-t1" role="tabpanel" aria-labelledby="v-pills-t1-tab">
                            <form class="admin-form" action="{{route('back.first.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_1">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_1" class="form-control" id="subtitle_color_1"
                                                value="{{isset($first_banner['subtitle_color_1']) ? $first_banner['subtitle_color_1'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_1">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_1" class="form-control" id="title_color_1"
                                                value="{{isset($first_banner['title_color_1']) ? $first_banner['title_color_1'] : '#000000'}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_2">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_2" class="form-control" id="subtitle_color_2"
                                                value="{{isset($first_banner['subtitle_color_2']) ? $first_banner['subtitle_color_2'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_2">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_2" class="form-control" id="title_color_2"
                                                value="{{isset($first_banner['title_color_2']) ? $first_banner['title_color_2'] : '#000000'}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_3">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_3" class="form-control" id="subtitle_color_3"
                                                value="{{isset($first_banner['subtitle_color_3']) ? $first_banner['subtitle_color_3'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_3">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_3" class="form-control" id="title_color_3"
                                                value="{{isset($first_banner['title_color_3']) ? $first_banner['title_color_3'] : '#000000'}}" >
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.secend.banner.update')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_1">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_1" class="form-control" id="subtitle_color_1"
                                                value="{{isset($secend_banner['subtitle_color_1']) ? $secend_banner['subtitle_color_1'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_1">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_1" class="form-control" id="title_color_1"
                                                value="{{isset($secend_banner['title_color_1']) ? $secend_banner['title_color_1'] : '#000000'}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_2">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_2" class="form-control" id="subtitle_color_2"
                                                value="{{isset($secend_banner['subtitle_color_2']) ? $secend_banner['subtitle_color_2'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_2">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_2" class="form-control" id="title_color_2"
                                                value="{{isset($secend_banner['title_color_2']) ? $secend_banner['title_color_2'] : '#000000'}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_3">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_3" class="form-control" id="subtitle_color_3"
                                                value="{{isset($secend_banner['subtitle_color_3']) ? $secend_banner['subtitle_color_3'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_3">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_3" class="form-control" id="title_color_3"
                                                value="{{isset($secend_banner['title_color_3']) ? $secend_banner['title_color_3'] : '#000000'}}" >
                                        </div>
                            ...
                            <form class="admin-form" action="{{route('back.third.banner.update')}}"
                                ...
                                @csrf
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_1">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_1" class="form-control" id="subtitle_color_1"
                                                value="{{isset($third_banner['subtitle_color_1']) ? $third_banner['subtitle_color_1'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_1">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_1" class="form-control" id="title_color_1"
                                                value="{{isset($third_banner['title_color_1']) ? $third_banner['title_color_1'] : '#000000'}}" >
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="subtitle_color_2">{{ __('Subtitle Color') }}</label>
                                            <input type="color" name="subtitle_color_2" class="form-control" id="subtitle_color_2"
                                                value="{{isset($third_banner['subtitle_color_2']) ? $third_banner['subtitle_color_2'] : '#377dff'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="title_color_2">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color_2" class="form-control" id="title_color_2"
                                                value="{{isset($third_banner['title_color_2']) ? $third_banner['title_color_2'] : '#000000'}}" >
                                        </div>
                                        <div class="form-group">
                                            <label for="url">{{ __('URL 2') }} *</label>
                                            <input type="text" name="url2" class="form-control" id="url2"
