								...
								<form class="admin-form" action="{{ route('back.slider.update',$slider->id) }}"
									...
									<div class="form-group">
										...
										<input type="color" name="text_color" class="form-control" id="text_color"
											value="{{ $slider->text_color ? $slider->text_color : '#ffffff' }}" >
									</div>

									<div class="form-group">
										<label for="title_color">{{ __('Title Color') }}</label>
										<input type="color" name="title_color" class="form-control" id="title_color"
											value="{{ $slider->title_color ? $slider->title_color : '#ffffff' }}" >
									</div>

									<div class="form-group">
										<label for="text_position">{{ __('Text Position') }}</label>
										<select name="text_position" class="form-control" id="text_position">
											<option value="left" {{ $slider->text_position == 'left' ? 'selected' : '' }}>{{ __('Left') }}</option>
											<option value="center" {{ $slider->text_position == 'center' ? 'selected' : '' }}>{{ __('Center') }}</option>
											<option value="right" {{ $slider->text_position == 'right' ? 'selected' : '' }}>{{ __('Right') }}</option>
										</select>
									</div>
