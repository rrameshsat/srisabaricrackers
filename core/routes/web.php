...
Route::group(['middleware' => ['adminlocalize', 'demo']], function () {
    Route::prefix('admin')->group(function () { 
        ...
        Route::get('/login-submit', 'Auth\Back\LoginController@loginRedirect');
        ...
        Route::group(['middleware' => 'permissions:Manage Products'], function () {
            ...
            Route::get('item/clone/{item}', 'Back\ItemController@clone')->name('back.item.clone');
        ...
        Route::group(['middleware' => 'permissions:Manages Pages'], function () {
            ...
            Route::get('page/menu-status/{id}/{status}', 'Back\PageController@menuStatus')->name('back.page.menu.status');
        ...
        Route::group(['middleware' => 'permissions:Manage Site'], function () {
            ...
            Route::get('slider/{slider}/show', 'Back\SliderController@show')->name('back.slider.show');
...
Route::group(['middleware' => 'maintainance'], function () {
    Route::group(['middleware' => 'localize'], function () {
        ...
        Route::get('/quick/shopping', 'Front\FrontendController@quickShopping')->name('front.quick.shopping');
        Route::get('/checkout/quickshopping', 'Front\BookingController@index')->name('front.checkout.quickshopping');
        ...
        require base_path('routes/front-cart-catalog.php');
        require base_path('routes/front-checkout.php');
require base_path('routes/test-route.php');
        require base_path('routes/front-payment.php');
...
Route::get('/debug-api', function() {
    return ['status' => 'working', 'api' => 'test'];
});
