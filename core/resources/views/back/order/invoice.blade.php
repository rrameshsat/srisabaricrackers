                                    ...
                                    <table class="table my-4">
                                        ...
                                        <tbody>
                                            ...
                                            @foreach (json_decode($order->cart, true) as $item)
                                                @php
                                                    $total += \App\Helpers\PriceHelper::cartEntryUnitPrice($item) * ($item['qty'] ?? 0);
                                                    $option_price += empty($item['tax_exempt']) && empty($item['quick_shopping']) ? (isset($item['attribute_price']) ? $item['attribute_price'] : 0) : 0;
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="px-0 text-right">
                                                        @php
                                                            $total_price =
                                                                \App\Helpers\PriceHelper::cartEntryTotalPrice($item);
                                                        @endphp
