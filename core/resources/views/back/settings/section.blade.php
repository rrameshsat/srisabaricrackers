                                                ...
                                                <div class="row justify-content-center">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="card shadow-sm mt-4">
                                                            <div class="card-body">
                                                                <h5 class="mb-3">{{ __('Minimum Order Notice') }}</h5>
                                                                <div class="form-group">
                                                                    <label class="switch-primary">
                                                                        <input type="checkbox" class="switch switch-bootstrap" name="is_min_order_message" value="1" {{ $extra_settings->is_min_order_message == 1 ? 'checked' : '' }}>
                                                                        <span class="switch-body"></span>
                                                                        <span class="switch-text">{{ __('Enable minimum order warning') }}</span>
                                                                    </label>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="minimum_order_amount">{{ __('Minimum Order Amount') }}</label>
                                                                    <input type="text" name="minimum_order_amount" id="minimum_order_amount" class="form-control" value="{{ old('minimum_order_amount', $extra_settings->minimum_order_amount ?? 3000) }}" placeholder="{{ __('Enter minimum order amount') }}">
                                                                    <small class="text-muted">{{ __('Example: 3000') }}</small>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="minimum_order_message">{{ __('Warning Message') }}</label>
                                                                    <textarea name="minimum_order_message" id="minimum_order_message" class="form-control" rows="3" placeholder="{{ __('Enter warning message') }}">{{ old('minimum_order_message', $extra_settings->minimum_order_message ?? 'Minimum order amount must be above Rs.3000') }}</textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="card shadow-sm mt-4">
                                                            <div class="card-body">
                                                                <h5 class="mb-3">{{ __('State Delivery Charge') }}</h5>
                                                                <div class="form-group">
                                                                    <label class="switch-primary">
                                                                        <input type="checkbox" class="switch switch-bootstrap" name="is_state_delivery_charge" value="1" {{ $extra_settings->is_state_delivery_charge == 1 ? 'checked' : '' }}>
                                                                        <span class="switch-body"></span>
                                                                        <span class="switch-text">{{ __('Enable state wise delivery charge') }}</span>
                                                                    </label>
                                                                    <small class="text-muted d-block mt-2">{{ __('When enabled, delivery charge will be applied based on the selected state. When disabled, state delivery charge will not be applied.') }}</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
