                              ...
                              <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <form  action="{{ route('back.slider.store') }}" method="POST"
                                        ...
                                        <div class="form-group">
                                            <label for="text_color">{{ __('Description Color') }}</label>
                                            <input type="color" name="text_color" class="form-control" id="text_color" value="#ffffff">
                                        </div>

                                        <div class="form-group">
                                            <label for="title_color">{{ __('Title Color') }}</label>
                                            <input type="color" name="title_color" class="form-control" id="title_color" value="#ffffff">
                                        </div>
