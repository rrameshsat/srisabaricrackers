                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <div class="col-lg-12 pb-1">
                                                                                    @php
                                                                                        $logoUrl = null;
                                                                                        if ($setting->logo) {
                                                                                            $logoUrl = url('/core/public/storage/' . $setting->logo);
                                                                                        } else {
                                                                                            $logoUrl = url('/core/public/storage/images/placeholder.png');
                                                                                        }
                                                                                    @endphp
                                                                                    <img class="admin-setting-img"
                                                                                        src="{{ $logoUrl }}"
                                                    ...
                                                    <div class="row justify-content-center">
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="google_analytics" class="form-control ltr" id="" placeholder="{{ __('Google Analytics') }}">{!! html_entity_decode($setting->google_analytics) !!}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="google_adsense" class="form-control ltr" id="" placeholder="{{ __('Google Adsense Code') }}">{!! html_entity_decode($setting->google_adsense) !!}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="google_recaptcha_site_key"
                                                                    class="form-control ltr" id="google_recaptcha_site_key"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="google_recaptcha_secret_key"
                                                                    class="form-control ltr" id="google_recaptcha_secret_key"
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <textarea name="facebook_pixel" class="form-control ltr" id="" placeholder="{{ __('Facebook Pixel') }}">{!! html_entity_decode($setting->facebook_pixel) !!}</textarea>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="facebook_messenger" class="form-control ltr" id=""
                                                                    placeholder="{{ __('Facebook Messenger Page Id') }}" value="{{ $setting->facebook_messenger }}">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="disqus" class="form-control ltr" id="" placeholder="{{ __('Disqus Link') }}" value="{{ $setting->disqus }}">
                                                            </div>
                                                        ...
                                                        <div class="col-lg-8">
                                                            ...
                                                            <div class="form-group">
                                                                <label class="switch-primary">
                                                                    <input type="checkbox"
                                                                        class="switch switch-bootstrap status"
                                                                        name="enable_header_currency_dropdown" value="1"
                                                                        {{ $setting->enable_header_currency_dropdown == 1 ? 'checked' : '' }}>
                                                                    <span class="switch-body"></span>
                                                                    <span
                                                                        class="switch-text">{{ __('Enable Header Currency Dropdown') }}</span>
                                                                </label>
                                                            </div>
