					...
					<div class="row justify-content-center">
						<div class="col-lg-12">
								<form class="admin-form" action="{{ route('back.shipping.update',$shipping->id) }}"
                                    ...
                                    <div class="form-group">
                                        <label class="text-left d-block" for="is_condition">
                                            <input type="checkbox" name="is_condition" value="1" {{ $shipping->is_condition == 1 ? 'checked' : '' }} class="my-2" id="is_condition">
