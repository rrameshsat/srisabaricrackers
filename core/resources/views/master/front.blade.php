                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="right-area">
                            ...
                            @if ($setting->enable_header_currency_dropdown == 1)
                            <div class="t-h-dropdown ">
                            ...
                            <div class="login-register ">
                                @if (!Auth::user())
                                    <a class="track-order-link mr-2" href="{{ route('user.login') }}">
                                        {{ __('Login') }}
                                    </a>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div class="site-branding"><a class="site-logo align-self-center"
                            href="{{ route('front.index') }}"><img
                                src="{{ url('/core/public/storage/' . $setting->logo) }}"
                                            ...
                                            <ul>
                                                ...
                                                <li class="t-h-dropdown">
                                                    ...
                                                    <div class="t-h-dropdown-menu">
                                                        ...
                                                        @endphp
                                                        @foreach ($headerPagesQuery->get() as $page)
                    ...
                    <div class="widget widget-links widget-light-skin">
                        ...
                        <ul>
                            @foreach ($footerUsefulLinks as $footerUsefulLink)
                                <li>
                                    <a class="" href="{{ $footerUsefulLink['url'] }}">{{ $footerUsefulLink['label'] }}</a>
                                </li>
                            @endforeach
                            @php
                            ...
                            @endphp
                            @foreach ($footerPagesQuery->get() as $page)
